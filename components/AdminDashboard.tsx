...
import { User, AppData, Submission, DisplayComplianceStatus, UserRole, Report } from '../types';
...
const AdminDashboard: React.FC<AdminDashboardProps> = ({ currentUser, data, onSubmissionsUpdate, onUsersUpdate, onReportsUpdate, onRefreshData }) => {
  ...
  const availableTabs = [
    ...
    { id: 'tagging', label: 'Report Summary View', roles: [UserRole.ADMIN, UserRole.MODERATOR] },
